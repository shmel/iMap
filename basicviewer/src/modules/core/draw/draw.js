/** A map drawing toolbar - partially integrated */
//items not integrated yet are:
//    support for selecting the color of the graphic symbol fill and outline
...
define(
    [
        ...
        "dojo/has",
        "dojo/json",
        //"dijit/TooltipDialog", //different from worcester
        //"dijit/form/DropDownButton",  //different from worcester
        "esri/toolbars/draw",
        "esri/graphic",
        "esri/symbols/SimpleMarkerSymbol",
        "esri/symbols/SimpleLineSymbol",
        "esri/symbols/SimpleFillSymbol",
        //"esri/dijit/ColorPicker", //different from worcester
    ...
    function (
        ...
        return declare([WidgetBase], {
            ...
            outlineColor: new Color([230, 0, 0, 1]),
            ...
            constructor: function (args) {
                ...
                var fpI = new ConstrainedFloatingPane({
                    ...
                    style: "position:absolute;top:20px;left:20px;width:250px;height:180px;z-index:100;visibility:hidden;overflow:hidden;",
                ...
                // support color pickers for fill and outline
